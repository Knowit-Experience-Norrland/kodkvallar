...
export type HeroParent = EventPage | StartPage;
...
export type ScheduledOperationAffectedDocument = Asset | ContactPage | EventPage | EventSignup | NewsletterSignup | StartPage;
